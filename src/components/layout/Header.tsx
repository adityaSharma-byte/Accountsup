...
const panelWrap =
  "pointer-events-none absolute inset-x-0 top-full z-50 flex justify-center pt-3 opacity-0 transition-opacity duration-150 group-hover:pointer-events-auto group-hover:opacity-100 group-focus-within:pointer-events-auto group-focus-within:opacity-100";
